...
- [ ] 8. Frontend UI: pipeline editor, encoding editor, PlotSvg with facets and legend, data table (guide §13) <!-- t:ntxd -->
- [ ] 9. Live tail: SSE-backed stream charts with an explicit gap indicator (guide §14) <!-- t:2jw4 -->
- [ ] 10. Export and permalink: chart to PNG, table to CSV, spec in the URL hash (guide §15) <!-- t:zqco -->
- [ ] 11. Tests and docs: tabular/handler tests, bun tests, end-to-end smoke, Playwright render check, README (guide §16) <!-- t:9qaa -->
