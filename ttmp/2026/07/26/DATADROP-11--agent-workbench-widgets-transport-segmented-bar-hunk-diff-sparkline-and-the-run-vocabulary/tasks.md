...
- [ ] Phase 5 — traceEntry presentation type: union, descriptor, registry, tone token, verbs and applyVerb mapping <!-- t:8wqc -->
- [ ] Phase 6 — TransportBar and the trace review panel; the review-only note is part of the deliverable <!-- t:qumm -->
- [ ] Phase 7 — barrels, stories coverage, and the break sweep with verbatim failures in the diary <!-- t:ei9s -->
