...
- [x] Phase 6 — Delete pkg/cli/output.go, add the --output ndjson deprecation shim and warning, write the 'cli-output' help page into pkg/doc/topics, update README and docker-compose <!-- t:cw3q -->
